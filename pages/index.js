...
<div className={classes.card}>
  ...
  <div className={classes.textcontainer}>
    ...
    <button href="https://pay.monzo.com/#F04EGRf_rHpfTiup1FH8WjIOge2MODAqZLWyNwdYr6Sn558nyzJteL25Ng%3D%3D">Money from me</button>
    <p className={classes.topay}>to pay for</p>
    <button href="https://www.udemy.com/share/1013fe/">whatever you fancy from here</button>
    </div>
  </div>
</div>
    </div>
